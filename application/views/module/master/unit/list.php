        ...
        <div class="row">
            <div class="col-xs-12 text-right">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>module/unit/add">
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                    ...
                    <div class="box-tools">
                        <form action="<?php echo base_url(); ?>module/unit/listing" method="POST" id="searchList">
                    ...
                    <?php if (!empty($unitRecords)) {
                        ...
                        <tr>
                          ...
                          <td class="text-center">
                            <a class="btn btn-sm btn-info" href="<?php echo base_url().'module/unit/edit/'.$record->id; ?>" title="Edit"><i class="fa fa-pencil"></i></a>
...
<script type="text/javascript">
    jQuery(document).ready(function(){
        ...
        // Delete unit
        jQuery('.deleteUnit').click(function(e){
            e.preventDefault();
            var unitId = jQuery(this).data('unitid');
            if(confirm("Are you sure you want to delete this unit?")) {
                window.location.href = baseURL + 'module/unit/deleteUnit/' + unitId;
            }
        });
    });
</script>
