        ...
        <div class="row">
            <div class="col-xs-12 text-right">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>module/brand/add">
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                    ...
                    <div class="box-tools">
                        <form action="<?php echo base_url(); ?>module/brand/listing" method="POST" id="searchList">
                    ...
                    <?php if (!empty($brandRecords)) {
                        ...
                        <tr>
                          ...
                          <td class="text-center">
                            <a class="btn btn-sm btn-info" href="<?php echo base_url().'module/brand/edit/'.$record->id; ?>" title="Edit"><i class="fa fa-pencil"></i></a>
...
<script type="text/javascript">
    jQuery(document).ready(function(){
        ...
        // Delete brand
        jQuery('.deleteBrand').click(function(e){
            e.preventDefault();
            var brandId = jQuery(this).data('brandid');
            if(confirm("Are you sure you want to delete this brand?")) {
                window.location.href = baseURL + 'module/brand/deleteBrand/' + brandId;
            }
        });
    });
