        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu" data-widget="tree">
           ...
           <!--  <li class="treeview">
            ...
            ?>
            <li class="treeview">
              <a href="<?php echo base_url(); ?>productListing"><i class="fa fa-user-circle-o"></i> Master
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="#"><i class="fa fa-circle-o"></i> Purchase Entry</a></li>
                <li><a href="#"><i class="fa fa-circle-o"></i> Purchase List</a></li>
                </ul>
            </li>
            <li class="treeview">
              <a href="#"><i class="fa fa-circle-o"></i> Sale
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
              <ul class="treeview-menu">
                <li><a href="#"><i class="fa fa-circle-o"></i> Sale Entry</a></li>
                <li><a href="#"><i class="fa fa-circle-o"></i> Sale List</a></li>
              </ul>
            </li>
            <li class="treeview">
